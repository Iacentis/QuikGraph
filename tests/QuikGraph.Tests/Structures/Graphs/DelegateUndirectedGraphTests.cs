...
namespace QuikGraph.Tests.Structures
{
    ...
    internal sealed class DelegateUndirectedGraphTests : DelegateGraphTestsBase
    {
        ...
        public void Construction_Throws()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new DelegateUndirectedGraph<int, Edge<int>>([], null));
            Assert.Throws<ArgumentNullException>(() => new DelegateUndirectedGraph<int, Edge<int>>(null, null));
        ...
        public void AdjacentEdge()
        {
            ...
            Assert.That(edge12, Is.SameAs(graph.AdjacentEdge(1, 0)));
            data.CheckCalls(1);
        }
        ...
        public void TryGetEdge()
        {
            ...
            var edge12 = new Edge<int>(1, 2);
            Assert.That(graph.TryGetEdge(1, 2, out Edge<int> gotEdge), Is.True);
            Assert.That(edge21, Is.SameAs(gotEdge));
