...
namespace QuikGraph.Tests.Algorithms.GraphColoring
{
    ...
    internal sealed class VertexColoringAlgorithmTests
    {
        ...
        public void VertexColoringEmptyGraph()
        {
            ...
            Assert.That(coloredVertices.Values.Contains(1),Is.False);

            // Expecting to no get any color
            Assert.That(0,Is.EqualTo(coloredVertices.Values.Count));
        }
        ...
        public void VertexColoringNoEdge()
        {
            ...
            */
            ...
            Assert.That(1,Is.EqualTo(result.Max() + 1));
            ...
            Assert.That(0,Is.EqualTo(result[0])); // 0 vertex = 0 color
            Assert.That(0,Is.EqualTo(result[1])); // 1 vertex = 0 color
            Assert.That(0,Is.EqualTo(result[2])); // 2 vertex = 0 color
            Assert.That(0,Is.EqualTo(result[3])); // 3 vertex = 0 color
            Assert.That(0,Is.EqualTo(result[4])); // 4 vertex = 0 color
        ...
        public void VertexColoringSimpleGraph()
        {
            ...
            */
            ...
            Assert.That(coloredVertices.Values.Contains(3),Is.False);

            int?[] result = coloredVertices.Values.ToArray();

            // Expecting to get 3 different colors
            Assert.That(3,Is.EqualTo(result.Max() + 1));
            ...
            // and corresponding colors of vertices
            Assert.That(0,Is.EqualTo(result[0])); // 0 vertex = 0 color
            Assert.That(1,Is.EqualTo(result[1])); // 1 vertex = 1 color
            Assert.That(2,Is.EqualTo(result[2])); // 2 vertex = 2 color
            Assert.That(0,Is.EqualTo(result[3])); // 3 vertex = 0 color
            Assert.That(1,Is.EqualTo(result[4])); // 4 vertex = 1 color
        ...
        public void VertexColoringGraph()
        {
            ...
            */
            ...
            Assert.That(0,Is.EqualTo(result[0])); // 0 vertex = 0 color
            Assert.That(0,Is.EqualTo(result[1])); // 1 vertex = 0 color
            Assert.That(1,Is.EqualTo(result[2])); // 2 vertex = 1 color
            Assert.That(1,Is.EqualTo(result[3])); // 3 vertex = 1 color
            Assert.That(2,Is.EqualTo(result[4])); // 4 vertex = 2 color
            Assert.That(0,Is.EqualTo(result[5])); // 5 vertex = 0 color
            Assert.That(0,Is.EqualTo(result[6])); // 6 vertex = 0 color
            Assert.That(1,Is.EqualTo(result[7])); // 7 vertex = 1 color
        ...
        public void VertexColoringCompleteGraph()
        {
            ...
            */
            ...
            Assert.That(coloredVertices.Values.Contains(6),Is.False);

            int?[] result = coloredVertices.Values.ToArray();

            // Expecting to get 6 different colors
            Assert.That(6,Is.EqualTo(result.Max() + 1));
            ...
            Assert.That(1,Is.EqualTo(result[1])); // 1 vertex = 1 color
            Assert.That(2,Is.EqualTo(result[2])); // 2 vertex = 2 color
            Assert.That(3,Is.EqualTo(result[3])); // 3 vertex = 3 color
            Assert.That(4,Is.EqualTo(result[4])); // 4 vertex = 4 color
            Assert.That(5,Is.EqualTo(result[5])); // 5 vertex = 5 color
        ...
        public void VertexColoringBipartiteGraph()
        {
            ...
            */
            ...
            Assert.That(coloredVertices.Values.Contains(2),Is.False);

            int?[] result = coloredVertices.Values.ToArray();

            // Expecting to get 2 different colors
            Assert.That(2,Is.EqualTo(result.Max() + 1));
            ...
            Assert.That(1,Is.EqualTo(result[3])); // 3 vertex = 1 color
            Assert.That(1,Is.EqualTo(result[4])); // 4 vertex = 1 color
            Assert.That(1,Is.EqualTo(result[5])); // 5 vertex = 1 color
            Assert.That(1,Is.EqualTo(result[6])); // 6 vertex = 1 color
