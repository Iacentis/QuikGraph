...
namespace QuikGraph.Tests.Algorithms
{
    ...
    internal sealed class UndirectedFirstTopologicalSortAlgorithmTests
    {
            ...
            where TEdge : IEdge<TVertex>
        {
            ...
            Assert.That(algorithm.Degrees,Is.Not.Null);
            Assert.That(graph.VertexCount,Is.EqualTo(algorithm.Degrees.Count));
        }
        ...
        public void Constructor()
        {
                ...
                where TEdge : IEdge<TVertex>
            {
                ...
                Assert.That(allowCycles,Is.EqualTo(algo.AllowCyclicGraph));
            }
