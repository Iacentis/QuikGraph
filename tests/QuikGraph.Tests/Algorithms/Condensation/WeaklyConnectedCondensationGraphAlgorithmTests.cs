...
namespace QuikGraph.Tests.Algorithms.Condensation
{
    ...
    internal sealed class WeaklyConnectedCondensationGraphAlgorithmTests : CondensationGraphAlgorithmTestsBase
    {
            ...
            where TEdge : IEdge<TVertex>
        {
            ...
            Assert.That(components, Is.EqualTo(condensedGraph.VertexCount), "Component count does not match.");
        }
        ...
        public void Constructor()
        {
                ...
                where TGraph : IMutableVertexAndEdgeSet<TVertex, TEdge>, new()
            {
                ...
                Assert.That(stronglyConnected, Is.EqualTo(algo.StronglyConnected));
                Assert.That(algo.CondensedGraph, Is.Null);
            }
        ...
        public void Constructor_Throws()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new WeaklyConnectedComponentsAlgorithm<int, Edge<int>>(null));
        ...
        public void MultipleWeaklyConnectedComponents()
        {
            ...
            Assert.That(condensedGraph, Is.Not.Null);
            Assert.That(3, Is.EqualTo(condensedGraph.VertexCount));
            Assert.That(0, Is.EqualTo(condensedGraph.EdgeCount));
